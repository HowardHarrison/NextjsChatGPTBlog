  ...
  return (
    <section className='pt-3 pb-10'>
     <div className='flex items-center gap-3'>
      ...
      <p className='text-sm'>
       Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque unde reprehenderit
        dolorem, aut ad vel repellat consequuntur consectetur cum culpa!
      </p>
     </div>
     ...
     {/*grid option */}
      ...
      <p className='text-sm'>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Soluta repudiandae enim 
        consequatur Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit,
         ducimus quia laudantium dolore reiciendis aperiam exercitationem repellendus?
      </p>
